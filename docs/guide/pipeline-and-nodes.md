...
Cache data is stored in `.efes-cache/` and can be cleared by stopping the pipeline and clicking **Clean** in the GUI, or running `efes-ng clean` on the command line.
:::
