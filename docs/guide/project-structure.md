...
A typical EFES-NG Prototype project has the following structure:
...
│   └── website/              # Eleventy templates & assets
│       ├── _includes/
│       │   └── layouts/
│       ├── assets/
│       └── .eleventy.js
...
> [!tip]
> The project structure is flexible — you can organize your source files however you like. The structure shown here is the recommended convention used by the project generator and this documentation.
...
These are all gitignored and can be safely deleted (`npx efes-ng clean`).
