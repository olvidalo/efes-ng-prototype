...
<!--
    ...
    Reads per-document metadata XML files and produces a single JSON array
    of search documents. Each document contains all fields from the <search>
    section plus the documentId.
