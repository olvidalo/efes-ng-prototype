// Core
export { Pipeline, PipelineNode, from, files, inputIsNodeOutputReference, inputIsFilesRef } from './core/pipeline';
export type { Input, NodeOutput, FilesRef, UnifiedOutputConfig, PipelineNodeConfig, PipelineContext } from './core/pipeline';
