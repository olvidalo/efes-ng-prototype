// Core
export { Pipeline, PipelineNode, from, fileRef, inputIsNodeOutputReference } from './core/pipeline';
export type { Input, NodeOutput, FileRef, UnifiedOutputConfig, PipelineNodeConfig, PipelineContext } from './core/pipeline';
